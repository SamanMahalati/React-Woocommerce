...
const DetailProduct = () => {
    ...
    const mainProduct = products.find(product => product.CourseName == productName)
    const { themeIsLight , setThemeIsLight } = useContext(ThemeContext)

    return (
        <section className={themeIsLight ? style.DetailContainer : style.DetailContainerDark}>
            {
                mainProduct ?
                    <>
                        <div className={themeIsLight ? style.DetailsBoxContainer : style.DetailsBoxContainerDark}>

                            <div className={style.DetailsCourseContainer}>
                                <div className={style.DetailsRightPart}>
                                    <div className={style.DetailsTitleContainer}>
                                        <h2 className={themeIsLight ? style.DetailProductName : style.DetailProductNameDark}>{mainProduct.Name}</h2>
                                        <h5 className={themeIsLight ? style.DetailProductGoals : style.DetailProductGoalsDark}>{mainProduct.DetailsTitle}</h5>
                                    </div>
                                ...
                                <div className={style.DetailLeftPart}>
                                    ...
                                    <div className={style.DetailProductBenfits}>
                                        <div className={themeIsLight ? style.BenefitContainer : style.BenefitContainerDark}>
                        ...
                        <div className={themeIsLight ? style.ProductDetailContainer : style.ProductDetailContainerDark}>
                            <h2>{`چرا  ${mainProduct.Name} ؟`}</h2>
                            <h4 className={style.PeoductDetailText}>{mainProduct.Details}</h4>
                        </div>
                    </>
