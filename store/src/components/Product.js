    ...
    return (
        <div className={style.ProductCart}>
            ...
            <div className={style.ProductContent}>
                ...
                <div className={style.ProductTimeContainer}>
                    ...
                    <span className={style.ProductTime}>{`مدت :  ${Time}  ساعت`}</span>
                </div>

                <div className={style.ProductLinkContainer}>
                    <Link to={`/products/${id}`}>مشاهده دوره </Link>
